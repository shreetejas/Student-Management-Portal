                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="width: 1000px;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if (isset($_POST['sem'])) {
                                                    $a=mysqli_query($conn,"SELECT * FROM `student` inner join section on student.sec=section.secid inner join dept on section.deptid=dept.deptid WHERE student.sec='$_POST[dept]' AND student.sem='$_POST[sem]' AND classcord='Approved'");
                                                }
                                                else{
                                                $a=mysqli_query($conn,"SELECT * FROM `student` inner join section on student.sec=section.secid inner join dept on section.deptid=dept.deptid WHERE section.secid='$_SESSION[sec]' AND classcord='Approved'");
                                                }
                                                while ($f=mysqli_fetch_array($a,MYSQLI_ASSOC)) {
                                            ?>
                                            <tr>
