                                ...
                                <div class="card-body card-block">
                                        ...
                                        <form method="post" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly="" class="form-control" required="" value="<?php echo $f["internal"]; ?>" placeholder="Enter Internal Marks" name="internal" pattern="[0-9]{2}" maxlength="2">
                                            </div>
                                             <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Seminar Marks</label>
                                                <input type="text" readonly="" class="form-control" required="" value="<?php echo $f["seminar"]; ?>" placeholder="Enter Seminar Marks" name="seminar" pattern="[0-9]{2}" maxlength="2">
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Project </label>

                                              <select name="project" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["project"]; ?>"><?php echo $f["project"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Internship </label>

                                              <select name="intership" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["internship"]; ?>"><?php echo $f["internship"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Placement Form </label>

                                              <select name="pf" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["placement"]; ?>"><?php echo $f["placement"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Anti Raging Form </label>

                                              <select name="arf" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["antirag"]; ?>"><?php echo $f["antirag"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Mentorship Form </label>

                                              <select name="mf" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["mentership"]; ?>"><?php echo $f["mentership"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">CCO Approval </label>

                                              <select name="status" required="" disabled="" class="form-control">
                                                
                                                <option value="<?php echo $f["classcord"]; ?>"><?php echo $f["classcord"]; ?></option>
                                               </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">HOD Approval </label>
                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST['submit'])) 
                                            {
                                                    ...
                                                    $q=mysqli_query($con,"UPDATE `student` SET hod='$_POST[status]' WHERE `std_id`='$_POST[sid]'");
                                                    if ($q) {
                                                            echo "
                                                            <script>
                                                            alert('Updated');
                                                            window.location = 'View_Studenthod.php';
                                                            </script>
                                                            ";  
