                                ...
                                <div class="card-body card-block">
                                        ...
                                        <?php } ?>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" id="nf-email" name="sec" placeholder="Enter Section " class="form-control" required="" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 32"  maxlength="1">
                                            </div>
                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST['submit'])) 
                                            {
                                                $dept = $_POST['dept'];
                                                $sec = $_POST['sec'];
                                                $a=mysqli_query($con,"SELECT * FROM `section` where `sec`='$sec' and deptid='$dept'");
                                                ...
                                                {
                                                    $q=mysqli_query($con,"INSERT INTO `section`(`deptid`, `sec`) VALUES ('$dept','$sec')");
                                                    if ($q) {
                                                            echo "
                                                            <script>
                                                            alert('Inserted');
