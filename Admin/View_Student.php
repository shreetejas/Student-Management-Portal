                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="width: 1000px;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $a=mysqli_query($conn,"SELECT * FROM `student` inner join section on student.sec=section.secid inner join dept on section.deptid=dept.deptid");
                                                ...
                                                <td><?php echo $f["sem"]; ?></td>
                                                 ...
                                                 <td> 
                                                    ...
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to edit')" href="editstudent.php?sid=<?php echo $f["std_id"]; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                    </button> || <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to delete')" href="deletestudent.php?sid=<?php echo $f["std_id"]; ?>"> <i class="zmdi zmdi-delete"></i></a>
                                                    </button>
                                                    </div>
