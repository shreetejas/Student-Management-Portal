                                ...
                                <div class="card-body card-block">
                                        ...
                                        <?php } ?>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <input type="text" id="nf-email" name="sname" placeholder="Enter name " class="form-control" required="" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 32"  maxlength="51">
                                            </div>
                                             <div class="form-group">
                                                <label for="nf-email" class=" form-control-label">Regno</label>
                                                <input type="text" id="nf-email" name="regno" placeholder="Enter Regno " class="form-control" required=""  maxlength="51">
                                            </div>
                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST['submit'])) 
                                            {
                                                ...
                                                $a=mysqli_query($con,"SELECT * FROM `student` where `Reg_no`='$regno' or (`sec`='$dept' and sem='$sem' and Name='$name') ");
                                                ...
                                                {
                                                    $q=mysqli_query($con,"INSERT INTO `student`( `Name`, `Reg_no`, `sec`, `sem`,`classcord`,`hod`) VALUES ('$name','$regno','$dept','$sem','NA','Pending')");
                                                    if ($q) {
                                                            echo "
                                                            <script>
                                                            alert('Inserted');
