                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="width: 1000px;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $a=mysqli_query($conn,"SELECT * FROM `teacher` inner join section on teacher.sec=section.secid inner join dept on section.deptid=dept.deptid");
                                                while ($f=mysqli_fetch_array($a,MYSQLI_ASSOC)) {
                                            ?>
                                            <tr>
                                                  <td><?php echo $f["tname"]; ?></td>
                                                <td><?php echo $f["deptname"].'-'.$f["sec"]; ?></td>
                                                <td><?php echo $f["designation"]; ?></td>
                                                <td><?php echo $f["temail"]; ?></td>
                                             
                                                 <td> 
                                                    <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to edit')" href="editteacher.php?sid=<?php echo $f["tid"]; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                    </button> || <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to delete')" href="deleteteacher.php?sid=<?php echo $f["tid"]; ?>"> <i class="zmdi zmdi-delete"></i></a>
                                                    </button>
                                                    </div>
