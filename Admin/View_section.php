                                    ...
                                    <table class="table table-borderless table-striped table-earning" style="width: 1000px;">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $a=mysqli_query($conn,"SELECT * FROM `section` inner join dept on section.deptid=dept.deptid");
                                                ...
                                                <td><?php echo $f["sec"]; ?></td>
                                                 ...
                                                 <td> 
                                                    ...
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to edit')" href="editsec.php?sid=<?php echo $f["secid"]; ?>"><i class="zmdi zmdi-edit"></i></a>
                                                    </button> || <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                        <a onclick="return confirm('do you want to delete')" href="deletesec.php?sid=<?php echo $f["secid"]; ?>"> <i class="zmdi zmdi-delete"></i></a>
                                                    </button>
                                                    </div>
